...
class Segment:
    ...
    def fromstrava(cls, stra):
        ...
        obj.links = []
        obj.created_at = stra.created_at.strftime("%m/%d/%Y, %H:%M:%S")
        obj.activity_type = stra.activity_type
        obj.coords = polyline.decode(obj.polyline)
        return obj
    ...
    def fromdict(cls, segdict):
        ...
        if 'polyline' in segdict:
            ...
            obj.coords = polyline.decode(segdict['polyline'])
        else:
            obj.polyline = None
            obj.coords = []
        if 'links' in segdict:
            ...
            obj.links = []
        obj.created_at = segdict['created_at']
        obj.activity_type = segdict['activity_type']
        return obj
